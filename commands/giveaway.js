...
module.exports.run = async(bot, message, args) => {
   ...
   // Argumenten die we later nodig hebben.
    ...
    if (!message.member.hasPermission("MANAGE_MESSAGES")) return message.channel.send("You do not meet the requirements to perform this action.");
    ...
    setTimeout(function () {
        ...
        if (peopleReacted.length < winnerCount) {
            return message.channel.send("There weren't enough players so the bot has won.");
        }
